...
public class BbsController {
    ...
    public List<BbsDto> scrapBbsList(){
        System.out.println("BbsController scrapBbsList " + new Date());

        List<BbsDto> list = service.scrapBbsList();
        return list;
    }
