...
public class BbsDto {
	...
	public BbsDto(String id, int seq, String title, String content, String hashtag, String wdate,
	...
	public BbsDto(String id, String title, String content,String hashtag, String shopname,
